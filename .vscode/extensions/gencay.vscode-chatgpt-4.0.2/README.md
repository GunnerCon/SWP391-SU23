...
### ⚠️⚠️⚠️ You can try [this extension instead from Genie AI](https://marketplace.visualstudio.com/items?itemName=genieai.chatgpt-vscode) ⚠️⚠️⚠️
...
### The vscode-chatgpt project was stopped but it will be continued by GenieAI team via another extension.

You can try out this extension on marketplace: [ChatGPT - Genie AI](https://marketplace.visualstudio.com/items?itemName=genieai.chatgpt-vscode)
...
> If you are developing completely another extension without forking this project, and release it to the public, make sure you follow License requirements.

This project is released under ISC License. Copyright notice and the respective permission notices must appear in all copies.
