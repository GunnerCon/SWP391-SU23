                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            <li class="mega-menu-col col-lg-9">
                                                <ul class="d-lg-flex">
                                                    ...
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul> 
                                                            <li class="dropdown-header" style="font-size: 25px"><a href="MainController?action=ShowRoomHN">Hà Nội</a> </li>
                                                    ...
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                          <li class="dropdown-header" style="font-size: 25px"><a href="MainController?action=ShowRoomDN">Đà Nẵng</a> </li>
                                                    ...
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                            ...
                                                            <li class="dropdown-header" style="font-size: 25px"><a href="MainController?action=ShowRoomHCM">Hồ Chí Minh</a> </li>
