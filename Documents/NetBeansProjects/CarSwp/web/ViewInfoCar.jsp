                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="pr_detail">
                                    ...
                                    <div class="cart_extra">
                                        ...
                                        <div class="cart_btn">
                                            <button class="btn btn-fill-out btn-addtocart" type="button"><i class="icon-heart"></i> Lưu tin</button>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
                                  <c:forEach items="${requestScope.car}" var="c2">
                                <div class="item">
                                    <div class="product">
                                        ...
                                        <div class="product_info">
                                            <h6 class="product_title"><a href="ViewInfoCarServlet?carId=${c.carId}">${c2.carName}</a></h6>
                                            <div class="product_price">
