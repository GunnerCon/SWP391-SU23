<%-- 
    Document   : Login
    Created on : 22/06/2023, 4:20:41 PM
    Author     : hoang
--%>
                        ...
                        <div class="col-md-3">
                            <div class="text-center text-md-end">
                                <ul class="header_list">
                                    ...
                                    <li><a href="Signup.jsp"><i class="linearicons-user"></i><span>Register</span></a></li>
                    ...
                    <nav class="navbar navbar-expand-lg"> 
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            <li class="mega-menu-col col-lg-4">
                                                <ul> 
                                                    ...
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-list-left-sidebar.html">Toyota</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-left-sidebar.html">Lexus</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-right-sidebar.html">Mecedes-Benz</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-list.html">BMW</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-load-more.html">Honda</a></li>
                                                </ul>
                                            </li>
                                            <li class="mega-menu-col col-lg-4">
                                                <ul>
                                                    <!-- <li class="dropdown-header">Men's</li> -->
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-cart.html">Ford</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="checkout.html">Audi</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="wishlist.html">Nissa</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="compare.html">Kia</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="order-completed.html">Suzuki</a></li>
                                                </ul>
                                            </li>
                                            <li class="mega-menu-col col-lg-4">
                                                <ul>
                                                    <!-- <li class="dropdown-header">Kid's</li> -->
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-product-detail.html">Chevrolet</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-product-detail-left-sidebar.html">Isuzu</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-product-detail-right-sidebar.html">Madza</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-product-detail-thumbnails-left.html">VinFast</a></li>
                                                    <li><a class="dropdown-item nav-link nav_item" href="shop-product-detail-thumbnails-left.html">Volvo</a></li>
                                                </ul>
                                            </li>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    <a class="dropdown-toggle nav-link" href="#" data-bs-toggle="dropdown">Bán Xe</a>                           
                                </li>
                                                ...
                                                <ul class="d-lg-flex">
                                                    ...
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                            ...
                                                            <li class="dropdown-header"> Hà Nội</li>
                                                            <c:set value="${dao.ShowRoomDAO.getAllShowRoomHN()}" var="list" />
                                                                <c:forEach var="shn" items="${list}">
                                                                <h1>${shn.nameRoom} title</h1> 
                                                                </c:forEach>
                                                    ...
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                            <li class="dropdown-header"> Đà Nẵng</li>
                                                    ...
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                            <li class="dropdown-header"> Thành Phố Hồ Chí Minh</li>
            		...
            		<div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" required="" class="form-control" name="txtemail" placeholder="Your Email">
                            </div>
                            <div class="form-group mb-3">
                                <input class="form-control" required="" type="password" name="txtpassword" placeholder="Password">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-fill-out btn-block" name="action" value="login">Log in</button>
                            </div>
                        </form>
                        ...
                        <div class="form-note text-center">Don't Have an Account? <a href="Signup.jsp">Sign up now</a></div>
                    </div>
                </div>
            </div>
        </div>
