<%-- 
    Document   : SearchCar
    Created on : 28/06/2023, 1:29:51 AM
    Author     : hoang
--%>
                            ...
                            <div class="product_search_form rounded_input">
                                <form action="MainController" method="get">
                                    <div class="input-group">
                                        ...
                                        <input name="action" value="searchCars" class="form-control" placeholder="Search Product..." required=""  type="text">
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg"> 
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="dropdown">
                                    <a  class="nav-link dropdown-toggle " href="index-3.html">Home</a>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.html">${c.carname}</a></h6>
