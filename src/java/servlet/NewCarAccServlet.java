 ...
 * @author hoang
 */
public class NewCarAccServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String manuDate = request.getParameter("yearbycar");
            ...
            CarDAO c = new CarDAO();
            c.insertCar(carname, price, img, owners, status, pricebf, manuDate, brand, showrooms, decs, percentearn, acc);
