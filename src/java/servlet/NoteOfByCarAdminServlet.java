 ...
 * @author hoang
 */
public class NoteOfByCarAdminServlet extends HttpServlet {
...
//            Account acc = (Account) session.getAttribute("name");
            ...
            int orderId = Integer.parseInt(request.getParameter("byCar"));
            boolean c1 = OrderDAO.UpdateOrderNote(note, orderId);
            if (c1 != false) {
