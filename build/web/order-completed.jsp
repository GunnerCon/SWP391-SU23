                                ...
                                <div class="product_search_form rounded_input">
                                    <form action="MainController" method="get">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" placeholder="Tìm xe..." required=""  type="text">
                                            <button type="submit" class="search_btn2"><i class="fa fa-search"></i></button>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">Đăng kí thành công</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
            ...
            <div class="col-md-8">
                <div class="text-center order_complete">
                    ...
                    <div class="heading_s1">
                  	<h3>Quý khách đã đăng kí thành công!</h3>
                    </div>
                  	<p>Cảm ơn quý khách xem sản phẩm. Quý khách vui lòng đợi phản hồi </p>
