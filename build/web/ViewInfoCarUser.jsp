                            ...
                            <ul class="list_none pr_action_btn">
                                ...
                                <li class="add-to-cart">
                                    ...
                                    <form action="MainController" method="get">
                                        ...
                                        <br>
                                        <div><h4>Tên(*)</h4><input type="text" name="name" required="" style="width: 500px; height: 50px" value="${name.fullname}"></div>
                                        <div><h4>Số điện thoại(*)</h4><input type="text" name="phone" required="" style="width: 500px; height: 50px" value="${name.phone}"></div>
                                        <div><h4>Email(*)</h4><input type="text" name="email" required="" style="width: 500px; height: 50px" value="${name.email}"></div>
                                        ...
                                        <div>  <input type="hidden" value="${name.accID}" name="accId" /></div>
                                        <br>
                                        <button class="btn btn-fill-out btn-addtocart" type="submit" name="action" value="Mua">Xác nhận</button>
                                        <!--<input class="btn btn-fill-out btn-addtocart" type="submit" name="action" value="Mua">-->
