              ...
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                            <c:set value="${sessionScope.carOffer}" var="co"/>
                          <span class="fw-semibold d-block mb-1"> Người đăng kí, kí gửi </span>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                           <c:set value="${sessionScope.car}" var="car"/>
                          <span>Xe</span>
                ...
                <div style="text-align: center; width: 100%" class="col-12 col-md-8 col-lg-4 order-3 order-md-2">
                  <div class="row">
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                         <c:set value="${sessionScope.order}" var="order"/>
