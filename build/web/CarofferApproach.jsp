                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đăng kí gửi xe /</span> Chấp nhận </h4>

                            <!-- Basic Bootstrap Table -->
                            <div class="card">
                                <h5 class="card-header">Chấp nhận</h5>
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            <c:forEach  var="car" items="${listOffer}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="card-body">
                                                            <button  class="btn rounded-pill btn-outline-success  " value="${car.orderId}" name="orderId" onclick="showPopup()">Thêm xe</button>


                                                            <button  class="btn rounded-pill btn-outline-danger  " value="${car.orderId}" name="orderId" onclick="showPopuphuy()">Hủy</button>




                                                            <div id="popup-huy" class="popup" style="display: none;">
                                                                ...
                                                                <form action="MainController" method="post">
                                                                    ...
                                                                    <div class="mt-2">
                                                                        ...
                                                                        <button type="submit" class="btn btn-primary me-2 " name="action" value="luuhuyAdmin" >Lưu</button>
                                                            ...
                                                            <div id="popup" class="popup" style="display: none;">
                                                                <h1 style="text-align: center">Thêm xe kí gửi </h1>
                                                                ...
                                                                <form action="MainController" method="post">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label  class="col-md-2 col-form-label">Tên xe</label>
                                                                            <!--<div class="col-md-10">-->
                                                                            <input class="form-control" type="text" name="carname" value="${c.carName}" />
                                                                            <!--</div>-->
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 row col-md-4">
                                                                            ...
                                                                            <!--<div class="col-md-10">-->
                                                                            <input class="form-control" type="text" name="price" value="${c.price}" id="html5-search-input" />
                                                                            <!--</div>-->
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 row col-md-4">
                                                                            ...
                                                                            <label  class="col-md-2 col-form-label">Showrooms</label>
                                                                            <input type="text" name="showrooms" value="${c.showRooms}"  class="form-control"  />
                                                                            <c:choose>
                                                                                <c:when test="${c.showRooms==1}">
                                                                                    Car_Rừng
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==2}">
                                                                                    Car_Biển
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==3}">
                                                                                    Car_Anh
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==4}">
                                                                                    Car_Quang
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==5}">
                                                                                    Car_Cường
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==6}">
                                                                                    Car_Đạt
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==7}">
                                                                                    Car_Đức_Anh
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==8}">
                                                                                    Car_News
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==9}">
                                                                                    Car_Auto
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==10}">
                                                                                    Car_Sao
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==11}">
                                                                                    Car_Dao
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==12}">
                                                                                    Car_Duong
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==13}">
                                                                                    Car_Núi
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==14}">
                                                                                    Car_Dinh
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==15}">
                                                                                    Car_Mai
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==16}">
                                                                                    Car_Au
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==17}">
                                                                                    Car_Mua
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==18}">
                                                                                    Car_Nang
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==19}">
                                                                                    Car_Tuyet
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==20}">
                                                                                    Car_Lieu
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==21}">
                                                                                    Car_Nuoc
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==22}">
                                                                                    Car_X
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==23}">
                                                                                    Car_Q
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==24}">
                                                                                    Car_A
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==25}">
                                                                                    Car_Y
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==26}">
                                                                                    Car_V
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==27}">
                                                                                    Car_P
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==28}">
                                                                                    Car_T
                                                                                </c:when>
                                                                                <c:when test="${c.showRooms==29}">
                                                                                    Car_R
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    Car_S
                                                                        ...
                                                                        <div class="mb-3 row col-md-4">
                                                                            ...
                                                                            <!--                                            <div class="col-md-10">-->
                                                                            <input class="form-control" type="text" name="owner" value="${c.nameGuest}"id="html5-tel-input" />
                                                                            <!--</div>-->
                                                                        </div>

                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Ngày kí gửi</label>
                                                                            <!--<div class="col-md-10">-->
                                                                            <input class="form-control" type="text" name="date" placeholder="Ngày kí gửi...." id="html5-number-input" required="" />
                                                                            <!--</div>-->
                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Năm sản xuất</label>
                                                                            <!--<div class="col-md-10">-->
                                                                            <input class="form-control" type="number" name="year" placeholder="Năm sản xuất...." id="html5-number-input"required=""  />
                                                                            <!--</div>-->
                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">

                                                                            <label for="html5-email-input" class="col-md-2 col-form-label">Thương hiệu</label>
                                                                            <input class="form-control" type="text" name="brand" value="${c.brandId}" id="html5-number-input" />

                                                                        </div>
                                                                        <div class="mb-3 col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Kiểu dáng</label>
                                                                            <div class="col-md-10">
                                                                                <input class="form-control" type="text" placeholder="Kiểu dáng" name="style" id="html5-number-input"required=""  />
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Km đã đi </label>

                                                                            <input class="form-control" type="text" name="km" placeholder="Km đã đi ....." id="html5-number-input" required="" />

                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Nguyên liệu</label>

                                                                            <input class="form-control" type="text" name="fuel" id="html5-number-input"required=""  />

                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Tài nguyên</label>

                                                                            <input class="form-control" type="text" name="gear" placeholder="Xăng,Dầu...." id="html5-number-input"required=""  />

                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Xuất xứ</label>

                                                                            <input class="form-control" type="text" name="origin" placeholder="Xuất xứ" id="html5-number-input"required=""  />

                                                                        </div>
                                                                        <div class="mb-3 row col-md-4" >
                                                                            <label for="html5-color-input" class="col-md-2 col-form-label">Màu</label>

                                                                            <input class="form-control" type="text" name="color" placeholder="Màu xe" id="html5-color-input" required="" />

                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Chỗ ngồi</label>

                                                                            <input class="form-control" type="number" name="seats" placeholder="Chỗ ngồi" id="html5-number-input" required="" />

                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                            <label for="html5-number-input" class="col-md-2 col-form-label">Thông tin thêm về xe</label>

                                                                            <input class="form-control" type="text" name="desc" value="${c.description}" id="html5-number-input" />
                                                                        ...
                                                                        <div class="mt-2 ">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary me-2 " name="action" value="luuthongtinxeAdmin" >Lưu</button>
