                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row shop_container list">
                                <div class="col-md-4 col-6">
                                    <div class="product">
                                        <c:forEach items="${requestScope.listCarz}" var="c">


                                            <div class="product_img">
                                                <a href="ViewInfoCarUser?carId=${c.carId}&brandId=${c.brandId}&rooms=${c.roomId}">
                                                    <img src="${c.img}" alt="product_img1">
                                                </a>
                                            ...
                                            <div class="product_info">
                                                <h6 class="product_title"><a href="ViewInfoCarUser?carId=${c.carId}&brandId=${c.brandId}&rooms=${c.roomId}">${c.carName}</a></h6>
                                        ...
                                        <div class="list_product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        ...
                                                        <li class="add-to-cart"><a href="ViewInfoCarUser?carId=${c.carId}&brandId=${c.brandId}&rooms=${c.roomId}" class="nav-link search_trigger">Mua xe</a>
                                                       ...
                                                       <li ><a href="javascript:void(0);" "></a>
                                                           <div class="search_wrap "  >
                                                                    ...
                                                                    <form>
                                                                        ...
                                                                        <div><h4 >Giờ hẹn(*)</h4><input type="time" name="time" required="" style="width: 500px; height: 50px" placeholder="Giờ hẹn..."></div>
                        ...
                        <div class="col-lg-3 mt-4 pt-2 mt-lg-0 pt-lg-0">
                            <div class="sidebar">
                                <div class="widget">
                                    ...
                                    <c:forEach begin="1" end="5" items="${BrandDAO.getBrands()}" var="b">
                                        <ul class="widget_categories">
                                            <li><a href="shoplist?brandId=${b.brandID}"><span class="categories_name" style="font-size: 18px">${b.brandName}</span> <img style="width: 50px" src="${b.imgPath}" alt="Hinhf ành"></a></li>
