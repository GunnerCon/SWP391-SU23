                            ...
                            <div class="row shop_container list">
                                <div class="col-md-4 col-6">
                                    <div class="product">
                                        ...
                                        <c:forEach items="${sessionScope.searchname}" var="c">
                                            ...
                                            <div class="product_info">
                                                ...
                                                <div class="list_product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                       ...
                                                       <li class="add-to-cart"><a href="ViewInfoCarServlet?carId=${c.carId}&brandId=${c.brandId}&rooms=${c.roomId}" class="nav-link search_trigger">Mua xe</a>
