<%-- 
    Document   : ViewAllCar
    Created on : 28/06/2023, 3:27:56 AM
    Author     : hoang
--%>
...
<div class="breadcrumb_section bg_gray page-title-mini">
    <div class="container"><!-- STRART CONTAINER -->
        <div class="row align-items-center">
               <c:forEach items="${requestScope.showroom}" var="sa">
        	<div class="col-md-6">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">${sa.nameRoom}</li>
                </ol>
            </div>
                </c:forEach>
        </div>
                        ...
                        <div class="product">
                           <c:forEach var="c" items="${requestScope.car}">
                            ...
                            <div class="product_img">
                                <a href="ViewInfoCarServlet?carId=${c.carId}">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="ViewInfoCarUserServlet?carId=${c.carId}">${c.carName}</a></h6>
