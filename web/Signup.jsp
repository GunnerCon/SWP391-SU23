...
<!--                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-fill-out btn-block" name="action" value="sigup">Đăng kí</button>
                            </div>
                        </form>
...
<!--                        <ul class="btn-login list_none text-center">
                        ...
                        <div class="form-note text-center">Đã có tài khoản? <a href="login.jsp">Đăng nhập</a></div>
                    </div>
                </div>
            </div>
        </div>
