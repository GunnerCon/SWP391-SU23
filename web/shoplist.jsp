                    ...
                    <nav class="navbar navbar-expand-lg"> 
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                     <a class="dropdown-toggle nav-link" href="Signup.jsp" >Kí gửi Xe</a>                              
                                </li>
                                    ...
                                    <div class="product">
                                        <c:forEach var="c" items="${requestScope.car}">
                                            ...
                                            <div class="product_img">
                                                <a href="ViewInfoCarServlet?carId=${c.carId}&brandId=${c.brandId}">
                                            ...
                                            <div class="product_info">
                                                <h6 class="product_title"><a href="ViewInfoCarServlet?carId=${c.carId}&brandId=${c.brandId}">${c.carName}</a></h6>
                                                ...
                                                <div class="list_product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="login.jsp"><i class="icon-heart"></i> Mua xe</a></li>
                                                        <li><a href="shop-compare.html" class="popup-ajax"><i class="icon-shuffle"></i></a></li>
                                                        <li><a href="shop-quick-view.html" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                        ...
                        <div class="col-lg-3 mt-4 pt-2 mt-lg-0 pt-lg-0">
                            <div class="sidebar">
                                <div class="widget">
                                    ...
                                    <c:forEach begin="5" end="10" items="${BrandDAO.getBrands()}" var="b">
                                        <ul class="widget_categories">
                                            <li><a href="shoplist?brandId=${b.brandID}"><span class="categories_name" style="font-size: 18px">${b.brandName}</span> <img src="" alt="Hinhf ành"></a></li>
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="list_brand">
                                        <c:forEach begin="5" end="11"  items="${ShowRoomDAO.getAllShowRoom()}" var="s">
