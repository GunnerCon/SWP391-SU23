                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"> Xe</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <a href="NewCar.jsp" class="btn btn-outline-primary">+Thêm xe</a>
                                    ...
                                    <table id="myTable" class="table">
                                        ...
                                        <c:forEach var="car" items="${listC}">
                                            <tr>
                                                ...
                                                <td>${car.owner}</td>
                                                <td>   <button  class="btn rounded-pill btn-outline-success  "  value="${od.carId}" name="carId" onclick="showPopupCar('${car.carId}')">Chi tiết</button> 
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination" id="paginationList"></ul></nav> 
                        ...
                        <script>
                            ...
                            document.querySelector(".closeUpdate").addEventListener("click", function () {
