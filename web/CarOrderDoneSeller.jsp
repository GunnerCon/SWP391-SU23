...
<%@page import="dao.CarPurchaseContractDao"%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đặt mua xe /</span> Hoàn thành</h4>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            <c:forEach items="${listOrderDone}" var="od">
                                                <tr>
                                                    <td>${od.name}</td>      
                                                    <td>0${od.phone}</td>
                                                    <td>${od.email}</td>
                                                            ...
                                                            <c:forEach  items="${CarDAO.getCar(od.carId)}" var="car">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mb-3 row col-md-6">
                                                                        ...
                                                                        <h4>${car.price}Triệu</h4>


                                                                    </div>

                                                                    <c:forEach items="${CarPurchaseContractDao.getCarPurchaseContract(car.carId)}" var="u">
                                                                  

                                                                        <div class="mb-3 col-md-6">
                                                                            <label for="email" class="form-label">Ngày Công chứng</label>
                                                                            <h4>${u.dateNotarize}</h4>
                                                                        </div>
                                                                        <div class="mb-3 col-md-6">
                                                                            <label for="email" class="form-label">Ngày bán</label>
                                                                            <h4>${u.dateSale}</h4>
                                                                        </div>
                                                                    </c:forEach>
                                                                    <div class="mt-2">
                                            ...
                                            <!--                                                    <td>  <div class="card-body">
                                                                                                        <button  class="btn rounded-pill btn-outline-success  " value="" name="orderId" onclick="showPopup()">Hoàn thành</button>
                                            
                                            
                                                                                                        <button  class="btn rounded-pill btn-outline-danger  " value="" name="orderId" onclick="showPopuphuy()">Không hoàn thành</button>
