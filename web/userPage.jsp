                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="product_slider carousel_slider owl-carousel owl-theme nav_style1" data-loop="true" data-dots="false" data-nav="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
                              <c:forEach begin="1" end="20" var="c" items="${CarDAO.getAllCarFull()}">
                                 <div class="item">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="ViewInfoCarUser?carId=${c.carId}&brandId=${c.brandId}&rooms=${c.roomId}">
                                                    <img src="${c.img}" style="width: 600px; height: 240px">
                                                </a>
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme nav_style1" data-loop="true" data-dots="false" data-nav="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
                            ...
                            <c:forEach var="p"  items="${CarDAO.getAllCarByPrice()}">
                                <div class="item">
                                    <div class="product">
                                             <div class="product">
                                                <a href="ViewInfoCarUser?carId=${p.carId}&brandId=${p.brandId}&rooms=${p.roomId}" >
...
<!--                                                        <li><a href=" ProfileCarServlet?carIdz=${p.carId}" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>-->
                                        ...
                                        <div class="product_info">
                                           ...
                                           <h6 class="product_title"><a href="ViewInfoCarUser?carId=${p.carId}&brandId=${p.brandId}&rooms=${p.roomId}">${p.carName}</a></h6>
                                            <div class="product_price">
                                            ...
                                            <div class="link" style="color: red;
                                                 ...
                                                 font-size: 14px;
                                                 line-height: 18px;">
                                                <a href="ViewInfoCarUser?carId=${p.carId}&brandId=${p.brandId}">Xem chi tiết</a></div>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
                            ...
                            <c:forEach var="b" items="${BrandDAO.getBrands()}">
                                <div class="item">
                                    <div class="cl_logo" style="width: 75px">
                                        <a href="MainController?action=listCarbybranduser&brandIdz=${b.brandID}"><img style="width: 50px" src="${b.imgPath}" alt="cl_logo"/></a> 
                                    </div>
                                </div>
