<%-- 
    Document   : shoplist
    Created on : 04/07/2023, 11:41:15 AM
    Author     : hoang
--%>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb justify-content-md-end">
                            ...
                            <li class="breadcrumb-item active">Tổng hợp các loại xe</li>
                        </ol>
                    </div>
                </div>
            </div><!-- END CONTAINER-->
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row shop_container list">
                                <div class="col-md-4 col-6">
                                    <div class="product">
                                        <c:forEach var="c" items="${requestScope.car}">
                                ...
                                <div class="widget">
                                    ...
                                    <c:forEach begin="1" end="5" items="${BrandDAO.getBrands()}" var="b">
                                        <ul class="widget_categories">
                                            <li><a href="shoplist?brandId=${b.brandID}"><span class="categories_name" style="font-size: 18px">${b.brandName}</span> <img width="50px" src="${b.imgPath}" alt="Hinhf ành"></a></li>
