                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tài khoản/</span> Nhân viên</h4>
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                       ...
                                       <tbody>
                             <c:forEach var="cus" items="${listSeller}">
                        <tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="MainController" method="post">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control"
                                                                name="email" value="${cus.email}">
                                                        
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="password1">Trạng thái</label>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" name="action" value="saveChange">Lưu thay đổi</button>
                                                </div>
