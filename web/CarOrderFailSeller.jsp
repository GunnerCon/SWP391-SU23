                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đặt mua xe /</span> Không hoàn thành</h4>

                            <!-- Basic Bootstrap Table -->
                            <div class="card">
                                <h5 class="card-header">Không hoàn thành </h5>
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            <c:forEach items="${listOrderFail}" var="od">
                                                <tr>
                                                    <td>${od.name}</td>      
                                                    <td>0${od.phone}</td>
                                                    <td>${od.email}</td>
                                                    ...
                                                    <td><button  class="btn rounded-pill btn-outline-success  "  value="${od.carId}" name="carId" onclick="showPopupCar('${od.carId}')">Chi tiết</button>
                                                            ...
                                                            <c:forEach  items="${CarDAO.getCar(od.carId)}" var="car" >
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mb-3 col-md-6">
                                                                        <label for="email" class="form-label">Người bán</label>
                                                                       <h4></h4>
                                                                    </div>
