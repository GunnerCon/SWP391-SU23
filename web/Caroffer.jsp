...
<html
    ...
    <!--                                                    <button  class="btn rounded-pill btn-outline-success  " value="${car.orderId}" name="orderId" onclick="showPopup()">Chấp nhận</button>
    
    
                                                        -->

                                                    <button class="btn rounded-pill btn-outline-success" value="${car.orderId}" name="orderId" onclick="showPopup('${car.orderId}')">
                                                        Hoàn thành
                                                    </button>
                                                        ...
                                                        <form action="MainController" method="post">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <input class="form-control" type="date" min="" name="date"  placeholder="dd/mm/yyyy" required="" />
