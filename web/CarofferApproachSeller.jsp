                                            ...
                                            <c:forEach  var="car" items="${listOffer}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="card-body">
                                                            <button  class="btn rounded-pill btn-outline-success  " value="${car.orderId}" name="orderId" onclick="showPopup('${car.orderId}')">Thêm xe</button>
                                                                ...
                                                                <form action="MainController" method="post">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-3 row col-md-4">
                                                                            ...
                                                                            <div class="mb-3 row col-md-4">
                                                                            <label class="col-md-2 col-form-label">Phần trăm % </label>
                                                                            <!--<div class="col-md-10">-->
                                                                            <input class="form-control" type="text" name="percentearn" placeholder="Phần trăm hoa hồng" id="html5-search-input" />
                                                                            <!--</div>-->
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 row col-md-4">
                                                                            ...
                                                                            <!--<div class="col-md-10">-->
                                                                            <input class="form-control" type="text" name="date" placeholder="Ngày kí gửi...." id="html5-number-input" />
                                                                            <!--</div>-->
                                                                        </div>
                                                                        <div class="mb-3 row col-md-4">
                                                                        ...
                                                                        <div class="mb-3 col-md-6">
                                                                         ...
                                                                         <div class="mb-3 row col-md-4">
                                                                            ...
                                                                            <input type="hidden" name="showrooms" value="${c.showRooms}"  class="form-control"  />
                                                                            ...
                                                                            <input class="form-control" type="hidden" name="brand" value="${c.brandId}" id="html5-number-input" />

                                                                        </div>
                                                                        <div class="mt-2 ">

                                                                            <span  class="close ">&times;</span>
                                                                            <button type="submit" class="btn btn-primary me-2 " name="action" value="luuthongtinxe" >Lưu</button>
