                    ...
                    <nav class="navbar navbar-expand-lg"> 
                        <a class="navbar-brand" href="index.jsp">
                          <img class="logo_light" style="width: 25%" src="img/logo.jpg" alt="logo" />
                            <img class="logo_dark"style="width: 170px" src="img/logo.jpg" alt="logo" />
                        </a>
...
">
			...
			<div style="text-align:right;color:green">Chúc bạn mau bán được xe !<br> Thân ái, Carnews !</div>
                ...
                <div class="body_content" style=" width: 2000px">
                    <h4 style="  color: red; padding-left: 350px">Nhập thông tin xe</h4><br>
                   
                    <div class="left" style="width: 700px; 
                         float: left; ">
                        <div style="color: black; font-style: 18px; font-weight: 500">
                            <div class="form-group col-md-6 mb-3">
                                <input style="width: 1000px"  placeholder="Nhập tên *" id="first-name" class="form-control" name="name" type="text" required="">
                                        </div>
                            
                            
                            
                                        <div class="form-group col-md-6 mb-3">
                                            <input style="width: 1000px" placeholder="Nhập Email *" id="email" class="form-control" name="email" type="email" required="" >
                                        </div>
                            
                            
                                        <div class="form-group col-md-6 mb-3">
                                            <input  style="width: 1000px"  placeholder="Nhập số điện thoại *" id="phone" class="form-control"  name="phone"required="">
                                        </div>
...
<!--                                        <div class="form-group col-md-6 mb-3">
                ...
                <div style="clear:both;"></div><br>
                   <div class="m-t-20 text-center">
                       <button type="submit" style="border-radius: 50px; background: red; margin-top: 20px" class="btn btn-primary submit-btn" name="action" value="saveOffer"> Đăng kí</button>
