            		...
            		<div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" required="" class="form-control" name="txtemail" placeholder=" Email">
                            </div>
                            <div class="form-group mb-3">
                                <input class="form-control" required="" type="password" name="txtpassword" placeholder="Mật khẩu">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-fill-out btn-block" name="action" value="login">Đăng nhập</button>
                            </div>
                        </form>
                        ...
                        <div class="form-note text-center">Chưa có tài khoản? <a href="Signup.jsp">Đăng kí</a></div>
                    </div>
                </div>
            </div>
        </div>
