                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đăng kí gửi xe /</span> Xe đã thêm</h4>

                            <!-- Basic Bootstrap Table -->
                            <div class="card">
                                <h5 class="card-header">Xe đã thêm</h5>
                                <div class="table-responsive text-nowrap">
                                    ...
                                    <td>${car.price}triệu</td>
                                                    <td><c:choose>
                                                            <c:when test="${car.status=='4'}">
                                                                <span class="badge bg-label-primary me-1">Xe đã thêm</span>
                                                            </c:when>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" >
                                                                <a class="dropdown-item" href="javascript:void(0);"style="font-size: 10px"
                                                                   ><i class="bx bx-edit-alt me-1"></i> HOÀN THÀNH</a
                                                                >
                                                                <a class="dropdown-item" href="javascript:void(0);" style="font-size: 10px"
                                                                   ><i class="bx bx-trash me-1"></i> KHÔNG HOÀN THÀNH</a
                                                                >
                                                            </div>
                                                        </div>
                                                    </td>
